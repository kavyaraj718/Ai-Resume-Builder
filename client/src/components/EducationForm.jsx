            ...
            {data.map((education, index) => (
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <div className='grid md:grid-cols-2 gap-3'>
                        ...
                        <input value={education.degree || ""} onChange={(e) => updateEducation(index, "degree", e.target.value)} type='text' placeholder='Degree (e.g., Bachelor, Master)' className='px-3 py-2 text-sm' />
                        <input value={education.field || ""} onChange={(e) => updateEducation(index, "field", e.target.value)} type='text' placeholder='Field of Study (e.g., Computer Science, Business)' className='px-3 py-2 text-sm' />
