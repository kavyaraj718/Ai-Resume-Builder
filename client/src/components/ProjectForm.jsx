            ...
            {data.map((project, index) => (
                <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                    ...
                    <div className='grid gap-3'>
                        ...
                        <input value={project.type || ""} onChange={(e) => updateProject(index, "type", e.target.value)} type='text' placeholder='Project Type (e.g., Web App, Mobile App)' className='px-3 py-2 text-sm' />
                        <textarea rows={4} value={project.description || ""} onChange={(e) => updateProject(index, "description", e.target.value)} placeholder='Description of your project' className='w-full px-3 py-2 text-sm rounded-lg resize-none' />
                    </div>
